...
type MACCBlockScanner struct {
	*bitcoin.BTCBlockScanner
	g50WM *WalletManager
}

//NewBTCBlockScanner 创建区块链扫描器
func NewMACCBlockScanner(wm *WalletManager) *MACCBlockScanner {
	bs := &MACCBlockScanner{g50WM: wm}
...
func (bs *MACCBlockScanner) GetBalanceByAddress(address ...string) ([]*openwallet.Balance, error) {

	return bs.g50WM.getBalanceCalUnspent(address...)
