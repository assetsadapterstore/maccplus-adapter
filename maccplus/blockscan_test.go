...
func TestGetBlock(t *testing.T) {
	raw, err := tw.GetBlock("822e2f47cecff64bd1a8eefdc9ca58f3797ec1c6a51b6160da80e5fdd658ce33")
	if err != nil {
...
func TestGetTransaction(t *testing.T) {
	raw, err := tw.GetTransaction("d2c9d25569fe549025e548d0ecf02833c07522a17fe5cd4c39abeafef6ce61d6")
	if err != nil {
