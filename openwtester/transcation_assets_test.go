...
func TestTransfer(t *testing.T) {
	...
	addrs := []string{
		"MX3qNpiSR6Jcg1T2dq5WYHpUoMCEsn7QXr",
		"MWaEDpN17ZdPX45wMBqhb4AqSWrGCw5cNm",
		"MHGkrnHS6deRkHtAGMgGWbgw9vszyLGd4k",
		"MQuZ8x1FMJc6cBT959ssd2xAihsjGAxiUe",
		"MWWifjDLXEQwy6GdNJPpW7nFqCKJWXDy58",
		"MSh231rAV3h1suthYQQXu3gdTPN6cYnd14",
		"MHxSRZcuG6PmhzqQsChWmYpET3KnrcLkQh",
		"MHQFGmiA84Z8QwYbM5TWNw6BvuzNAkCWuj",
		"MFxx1MhDHDTP71GpkYxZXdGsahcC7ruVnC",
		"MS8AQpNsbFx2KS4rJzAcjYB7Y9BziEtYck",
	}

	tm := testInitWalletManager()
	walletID := "W9cfuB6XjzvwbshuKyThtw9GnLhMV6cDFg"
	accountID := "9ZaagX8s8JBex71wnckrscq7WgBARLppPEJRELVPNvqx"
...
func TestSummary(t *testing.T) {
	tm := testInitWalletManager()
	walletID := "W9cfuB6XjzvwbshuKyThtw9GnLhMV6cDFg"
	accountID := "3hyu45ncYU8gzx5TttUCW86HiiU8hGM2C3dbnthrNF6G"
	summaryAddress := "MTeUvoBeLpaMatXE6P9GvTmW2pSFt6kNLP"
